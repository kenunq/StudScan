# Generated by Django 3.2.3 on 2024-04-10 20:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=120, verbose_name='электронная почта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='User.group', verbose_name='Группа')),
        ...
        migrations.AddField(
            model_name='group',
            name='teachers',
            field=models.ManyToManyField(related_name='groups', to='User.Teacher', verbose_name='Учителя'),
        ),
    ]
